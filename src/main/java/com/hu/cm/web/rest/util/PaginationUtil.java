...
public class PaginationUtil {
    ...
    public static Pageable generatePageRequest(Integer offset, Integer limit, String sort, String direction) {
        if (offset == null || offset < MIN_OFFSET) {
            offset = DEFAULT_OFFSET;
        }
        if (limit == null || limit > MAX_LIMIT) {
        ...
        return new PageRequest(offset -1, limit, new Sort(Sort.Direction.fromString(direction), sort));
    }
