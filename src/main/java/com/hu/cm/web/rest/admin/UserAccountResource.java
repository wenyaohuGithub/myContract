...
public class UserAccountResource {
    ...
    public ResponseEntity<UserDTO> getAccount() {
        ...
        if(user == null){
            ...
            UserDTO dto = new UserDTO(user.getId(), user.getLogin(), null, user.getFirstName(), user.getLastName(),
                    user.getEmail(), user.getLangKey(), user.getDepartmentId(), roles, user.getCurrentAccount().getName());
    ...
    @RequestMapping(value = "/useraccount/reset_password/init",
        method = RequestMethod.POST,
        produces = MediaType.TEXT_PLAIN_VALUE)
    @Timed
    ...
    @RequestMapping(value = "/useraccount/reset_password/finish",
        method = RequestMethod.POST,
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
