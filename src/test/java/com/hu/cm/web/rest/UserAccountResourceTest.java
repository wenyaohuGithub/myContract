...
import com.hu.cm.web.rest.admin.UserAccountResource;
...
public class UserAccountResourceTest {
    ...
    public void setup() {
        ...
        ReflectionTestUtils.setField(userAccountResource, "userRepository", userRepository);
        ReflectionTestUtils.setField(userAccountResource, "userService", userService);
        ReflectionTestUtils.setField(userAccountResource, "mailService", mockMailService);

        UserAccountResource accountUserMockResource = new UserAccountResource();
        ReflectionTestUtils.setField(accountUserMockResource, "userRepository", userRepository);
        ReflectionTestUtils.setField(accountUserMockResource, "userService", mockUserService);
        ReflectionTestUtils.setField(accountUserMockResource, "mailService", mockMailService);

        this.restMvc = MockMvcBuilders.standaloneSetup(userAccountResource).build();
    ...
    public void testRegisterDuplicateLogin() throws Exception {
        ...
        UserDTO dup = new UserDTO(u.getLogin(), u.getPassword(), u.getLogin(), u.getLastName(),
            "alicejr@example.com", u.getLangKey(), u.getRoles(), "account");
    ...
    public void testRegisterDuplicateEmail() throws Exception {
        ...
        UserDTO dup = new UserDTO("johnjr", u.getPassword(), u.getLogin(), u.getLastName(),
            u.getEmail(), u.getLangKey(), u.getRoles(), "account");
